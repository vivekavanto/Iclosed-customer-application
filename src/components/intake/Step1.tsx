...
export function Step1({
    ...
    // ✅ SAME WORKFLOW AS TOP PROGRESS BAR
    const leftSteps = [
                            ...
                            {leftSteps.map((item) => {
                                ...
                                return (
                                    <div key={item.id} className="flex items-center gap-4">
                                        ...
                                        <span
                                            className={`text-sm transition-colors duration-300 ${isActive || isCompleted
                        ...
                        <div className="space-y-3">
                            {services.map((service) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`h-12 w-12 rounded-xl flex-shrink-0 flex items-center justify-center transition-all duration-300 ${isSelected
                                        ...
                                        <div
                                            className={`h-5 w-5 rounded-full border-2 flex-shrink-0 flex items-center justify-center mt-0.5 transition-all duration-300 ${isSelected
                                                    ? "border-[#C10007] bg-[#C10007]"
                                                    : "border-gray-200"
                                                }`}
                                        >
                                            {isSelected && (
                                    ...
                                    {closingCards.map((card) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`cursor-pointer rounded-xl p-5 transition-all duration-300 ${isSel
                                            ...
                                            >
                                                <div
                                                    className={`w-9 h-9 rounded-lg flex items-center justify-center mb-3 ${isSel
                                                            ? "bg-gradient-to-tr from-[#FF6B6B] to-[#C10007]"
                                                            : "bg-red-50"
                                                        }`}
                                                >
                                                    <Icon
                                                ...
                                                <h4
                                                    className={`text-sm font-semibold mb-1.5 leading-snug ${isSel
                                                            ? "text-[#C10007]"
                                                            : "text-gray-900"
                                                        }`}
                                                >
